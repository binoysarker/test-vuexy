      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <v-select
                v-model="buildingData.currentCity"
                :dir="$store.state.appConfig.isRTL ? 'rtl' : 'ltr'"
                :options="cityOptions"
                :reduce="val => val.value"
                :clearable="false"
